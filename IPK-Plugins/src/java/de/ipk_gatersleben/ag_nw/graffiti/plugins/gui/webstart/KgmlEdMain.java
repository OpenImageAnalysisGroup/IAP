...
public class KgmlEdMain {
	...
	public KgmlEdMain(final boolean showMainFrame, String applicationName, String[] args) {
		...
		GravistoMainHelper.initApplicationExt(GravistoMainHelper.getNewPluginManager(), args, splashScreen, cl, null, null);
	...
	public static void main(String[] args) {
		...
		DBEgravistoHelper.DBE_GRAVISTO_VERSION = "IAP - KGML Pathway Editor " + DBEgravistoHelper.DBE_GRAVISTO_VERSION_CODE;
		DBEgravistoHelper.DBE_GRAVISTO_NAME = stS + "IAP-KGML Pathway Editor" + stE + " - "
				+ "Edit, process, <br>and visualize KGML" + DBEgravistoHelper.kgmlFileVersionHint + " Pathway files!<br>";
		DBEgravistoHelper.DBE_GRAVISTO_NAME_SHORT = "IAP-KGML Pathway Editor";
