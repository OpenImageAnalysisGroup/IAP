...
\resetBoolean
\checkFileNoReset{side_height__mm__side_width__mm__side_area__px__top_area__px__side_fluspiderOverallImage.tex}{}{}
...
\ifthenelse{\boolean{isFile1}}{
	...
	\checkFile{side_height_norm__mm__side_width_norm__mm__side_area_norm__mm2__top_aspiderOverallImage.tex}{}{}
	\ifthenelse{\boolean{isFile1}}{

		\ownClearPage
		\subsection{Growth parameters, fluorescence, near-infrared and visible light
		color}
		...
		\subsection{Growth parameters, fluorescence, near-infrared and visible light
		color}
		\loadTex{side_height__mm__side_width__mm__side_area__px__top_area__px__side_fluspiderOverallImage}
...
\ifthenelse{\boolean{isFile1}}{
	...
	%%side.vis.hue.average
		...
		\ifthenelse{\boolean{isFile1}}{
			Visible hue average histogram for side view:
			\loadImage{side_vis_hue_averagenboxplot.pdf}
		}{}	
		
	%%top.vis.hue.average
		\ifthenelse{\boolean{isFile2}}{
			Visible hue average histogram for top view:
...
\ifthenelse{\boolean{isFile1}}{
	...
	\ifthenelse{\boolean{isFile1} \or \boolean{isFile2}}{
		...
		\ownClearPage
		\subsection{Average Fluo intensity}

		\ifthenelse{\boolean{isFile1}}{
		
			Average Fluorescence intensity for side view:
		
			\loadImage{side_fluo_intensity_average__relative_nboxplot.pdf}
		}{}
		\ifthenelse{\boolean{isFile2}}{
		
			Average Fluorescence intensity for top view:
...
\ifthenelse{\boolean{isFile1}}{
	...
	\ifthenelse{\boolean{isFile1} \or \boolean{isFile2}}{
		\ownClearPage
		\subsection{Average NIR intensity}
...
\ifthenelse{\boolean{isFile1}}{
	...
	\ifthenelse{\boolean{isFile1}}{
		...
		\checkFile{side_hull_area__px_nboxplot.pdf}{}{}
		\ifthenelse{\boolean{isFile1}}{
			\ownClearPageSub
			\subsubsection{Area}
			\begin{itemize}
		...
		\checkFile{side_hull_area_norm__mm_2_nboxplot.pdf}{}{}
		\ifthenelse{\boolean{isFile1}}{
			\ownClearPageSub
		...
		\checkFile{side_hull_pc1nboxplot.pdf}{}{}
		\ifthenelse{\boolean{isFile1}}{
			\ownClearPageSub
		...
		\checkFile{side_hull_pc1_normnboxplot.pdf}{}{}
		\ifthenelse{\boolean{isFile1}}{
			\ownClearPageSub
		...
		\checkFile{side_hull_pc2nboxplot.pdf}{}{}
		\ifthenelse{\boolean{isFile1}}{
			\ownClearPageSub
		...
		\checkFile{side_hull_pc2_normnboxplot.pdf}{}{}
		\ifthenelse{\boolean{isFile1}}{
			\ownClearPageSub
	...
	\ifthenelse{\boolean{isFile1}}{
		...
		\checkFile{top_hull_area__px_nboxplot.pdf}{}{}
		\ifthenelse{\boolean{isFile1}}{
			\ownClearPageSub
			\subsubsection{Area}
			\begin{itemize}
		...
		\checkFile{top_hull_area_norm__mm_2_nboxplot.pdf}{}{}
		\ifthenelse{\boolean{isFile1}}{
			\ownClearPageSub
			\subsubsection{Area (zoom corrected)}
			\begin{itemize}
		...
		\checkFile{top_hull_pc1nboxplot.pdf}{}{}
		\ifthenelse{\boolean{isFile1}}{
			\ownClearPageSub
			\subsubsection{PC1 - maximum distance}
			\begin{itemize}
		...
		\checkFile{top_hull_pc1_normnboxplot.pdf}{}{}
		\ifthenelse{\boolean{isFile1}}{
			\ownClearPageSub
			\subsubsection{PC1 - maximum distance (zoom corrected)}
			\begin{itemize}
		...
		\checkFile{top_hull_pc2nboxplot.pdf}{}{}
		\ifthenelse{\boolean{isFile1}}{
			\ownClearPageSub
			\subsubsection{PC2 - Opposite direction maxmium distance}
			\begin{itemize}
		...
		\checkFile{top_hull_pc2_normnboxplot.pdf}{}{}
		\ifthenelse{\boolean{isFile1}}{
			\ownClearPageSub
			\subsubsection{PC2 - Opposite direction maxmium distance (zoom corrected)}
			\begin{itemize}
