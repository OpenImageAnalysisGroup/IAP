...
\begin{lyxlist}{00.00.0000}
\item [{\includegraphics[width=13cm]{legend}}]~
\end{lyxlist}
\end{itemize}
...
\begin{lyxlist}{00.00.0000}
\item [{\includegraphics[width=13cm]{\string"Weight\lyxdot A\lyxdot \lyxdot g\lyxdot \string"}}]~
\item [{\includegraphics[width=13cm]{\string"Weight\lyxdot B\lyxdot \lyxdot g\lyxdot \string"}}]~
\end{lyxlist}
...
\item Unit: g\end{itemize}
\begin{lyxlist}{00.00.0000}
\item [{\includegraphics[width=13cm]{\string"Water\lyxdot \lyxdot weight\lyxdot diff\lyxdot \string"}}]~
\end{lyxlist}
...
\begin{lyxlist}{00.00.0000}
\item [{\includegraphics[width=13cm]{\string"volume\lyxdot iap\lyxdot \lyxdot px3\lyxdot \string"}}]~
\end{lyxlist}
\end{itemize}
...
\begin{lyxlist}{00.00.0000}
\item [{\includegraphics[width=13cm]{\string"volume\lyxdot iap_max\string"}}]~
\end{lyxlist}
\end{itemize}
...
\begin{lyxlist}{00.00.0000}
\item [{\includegraphics[width=13cm]{\string"volume\lyxdot fluo\lyxdot iap\string"}}]~
\end{lyxlist}
\end{itemize}
...
\begin{lyxlist}{00.00.0000}
\item [{\includegraphics[width=13cm]{\string"volume\lyxdot lt\lyxdot \lyxdot px3\lyxdot \string"}}]~
\end{lyxlist}
\end{itemize}
...
\item Unit: mm
\begin{lyxlist}{00.00.0000}
\item [{\includegraphics[width=13cm]{\string"side\lyxdot height\lyxdot norm\lyxdot \lyxdot mm\lyxdot \string"}}]~
\end{lyxlist}
\end{itemize}
...
\item Unit: mm
\begin{lyxlist}{00.00.0000}
\item [{\includegraphics[width=13cm]{\string"side\lyxdot width\lyxdot norm\lyxdot \lyxdot mm\lyxdot \string"}}]~
\end{lyxlist}
\end{itemize}
...
\begin{lyxlist}{00.00.0000}
\item [{\includegraphics[width=13cm]{\string"side\lyxdot area\lyxdot norm\lyxdot \lyxdot mm2\lyxdot \string"}}]~
\end{lyxlist}
\end{itemize}
...
\begin{lyxlist}{00.00.0000}
\item [{\includegraphics[width=13cm]{\string"side\lyxdot fluo\lyxdot intensity\lyxdot chlorophyl\lyxdot average\lyxdot \lyxdot relative\lyxdot \string"}}]~
...
\item Unit: relative intensity/pixel
\begin{lyxlist}{00.00.0000}
\item [{\includegraphics[width=13cm]{\string"side\lyxdot nir\lyxdot intensity\lyxdot average\lyxdot \lyxdot relative\lyxdot \string"}}]~
...
\begin{lyxlist}{00.00.0000}
\item [{\includegraphics[width=13cm]{\string"side\lyxdot leaf\lyxdot count\lyxdot median\lyxdot \lyxdot leafs\lyxdot \string"}}]~
\end{lyxlist}
\end{itemize}
...
\begin{lyxlist}{00.00.0000}
\item [{\includegraphics[width=13cm]{\string"side\lyxdot bloom\lyxdot count\lyxdot \lyxdot tassel\lyxdot \string"}}]~
\end{lyxlist}
\end{itemize}
...
\begin{lyxlist}{00.00.0000}
\item [{\includegraphics[width=13cm]{\string"side\lyxdot leaf\lyxdot length\lyxdot sum\lyxdot norm\lyxdot max\lyxdot \lyxdot mm\lyxdot \string"}}]~\end{lyxlist}
\end{itemize}
