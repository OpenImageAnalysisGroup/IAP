...
public class RemoteStreamServerInvokerHelper {
	 ...
	 * 
	 * @param server
	 *           the server on which to invoke the method
	 * @param methodCode
	 *           the code of the method to invoke, one of the {@code OUT_*_METHOD} constants
	 * @param parameters
	 *           parameters for the method invocation (may be {@code null} if the method takes no parameters)
	 * @return the result of the method call, (or {@code null} for void methods)
	 * @throws IOException
	 *            if the method call throws
	 */
	 ...
	 *           the server on which to invoke the method
	 * @param methodCode
	 *           the code of the method to invoke, one of the {@code IN_*_METHOD} constants
	 * @param parameters
	 *           parameters for the method invocation (may be {@code null} if the method takes no parameters)
	 * @return the result of the method call, (or {@code null} for void methods)
	 * @throws IOException
