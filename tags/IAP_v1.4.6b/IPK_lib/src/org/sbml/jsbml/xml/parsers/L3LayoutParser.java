/*
 * $Id: L3LayoutParser.java,v 1.1 2012-11-07 14:43:35 klukas Exp $
 * $URL: https://jsbml.svn.sourceforge.net/svnroot/jsbml/trunk/extensions/layout/src/org/sbml/jsbml/xml/parsers/L3LayoutParser.java $
 * ----------------------------------------------------------------------------
...
public class L3LayoutParser extends AbstractReaderWriter {
	...
	/**
	 * @see org.sbml.jsbml.xml.parsers.ReadingParser#processStartElement(String elementName, String prefix, boolean hasAttributes, boolean hasNamespaces, Object
	 *      contextObject)
	 */
			...
			boolean hasAttributes, boolean hasNamespaces, Object contextObject)
	{
		if (contextObject instanceof Model) {
			...
			if (elementName.equals(layout)) {
				...
				SpeciesGlyph speciesGlyph = (SpeciesGlyph) newElement;
				speciesGlyph.setLayoutId(layoutId);
			}
			else if (elementName.equals(reactionGlyph)) {
				newElement = new ReactionGlyph();
				ReactionGlyph reactionGlyph = (ReactionGlyph) newElement;
				reactionGlyph.setLayoutId(layoutId);
			}
