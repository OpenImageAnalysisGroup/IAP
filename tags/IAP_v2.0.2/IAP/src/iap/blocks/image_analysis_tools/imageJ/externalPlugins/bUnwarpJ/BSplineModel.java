...
{ /* begin class BSplineModel */
	...
	private final boolean coefficientsAreMirrored;
	 ...
	 * 
	 * @param ip
	 *           image pointer (ImageProcessor)
	 * @param isTarget
	 *           enables the computation of the derivative or not
	 ...
	 * @param offset
	 *           Offset of the beginning of the array with respect to the origin of c
	 */
	public BSplineModel(
			final double[] c,
			final int Ydim,
	 ...
	 * 
	 * @param D2
	 *           output, interpolation of the XY, XX and YY derivatives of the image
	 */
	 ...
	 *           y- point coordinate
	 * @param fromSub
	 *           flat to determine to do the interpolation from the subsampled version of the image
	 * @param fromCurrent
	 *           flag to determine the image to do the interpolation from
	 *           interpolated value
	 */
	...
	public void run()
	{
		if (image == null && ip != null)
		{
			...
			{
				final float scaleFactor = 1.0f / this.maxImageSubsamplingFactor;
	 ...
	 * @param array
	 * @param width
	 *           of the position of the column in the array
	 * @param x
	 *           column position in the array
	 * @param column
	 *           output, extracted column
	 */
