...
{ /* begin class Mask */
	 ...
	 *           image
	 * @param take_mask
	 *           flag to take the mask from the stack of images
	 */
	 ...
	 * 
	 * @param corners
	 *           array of coordinates of the bounding box
	 */
	 ...
	 * 
	 * @param tool
	 *           option to invert or not the mask
	 */
	public void fillMask(int tool)
	{
		...
		for (int y = 0; (y < height); y++)
			for (int x = 0; (x < width); x++) {
				...
				if (tool == PointAction.INVERTMASK)
					mask[k] = !mask[k];
				k++;
			}
	}
	 ...
	 * 
	 * @param i
	 *           index of the point in the polygong
	 ...
	 * Set the mask points.
	 * 
	 * @param listMaskPoints
	 *           list of points composing the mask
	 */
