...
public class DnDList
	...
	/**
	 * Constructs a default {@link DnDList} using a {@link javax.swing.DefaultListModel}.
	 * 
	 * @since 1.1
	 */
	public DnDList() {
	 ...
	 * passed list model that must be extended from {@link javax.swing.DefaultListModel}.
	 * 
	 * @param model
	 *           The model to use
	 * @since 1.1
	 ...
	 * filling in a {@link javax.swing.DefaultListModel} with the passed array of objects.
	 * 
	 * @param data
	...
	/**
	 * Constructs a {@link DnDList} by
	 * filling in a {@link javax.swing.DefaultListModel} with the passed {@link java.util.Vector} of objects.
	 * 
	 * @param data
	 *           The data from which to construct a list
	 * @since 1.1
		...
		if (transferable.isDataFlavorSupported(TransferableObject.DATA_FLAVOR)) {
			...
			if (obj != null) {
				...
				// Else is it moving down the list?
					...
					if (sourceIndex >= 0 && dropIndex > sourceIndex)
