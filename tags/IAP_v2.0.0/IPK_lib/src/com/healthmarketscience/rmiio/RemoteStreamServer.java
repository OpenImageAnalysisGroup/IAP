...
public abstract class RemoteStreamServer<StreamServerType, StreamType>
	 ...
	 * 
	 * @param exporter
	 *           the exporter that exported this object
	 */
	 ...
	 * way or another on the server object (may be left to the <code>unreferenced</code> method if the server object must live beyond
	 ...
	 * 
	 * @param remoteClose
	 *           indicates whether this was a remote close() call
	 *           or a local cleanup close after a failed transfer.
	 * @param transferSuccess
	 *           <code>true</code> iff all data was successfully
