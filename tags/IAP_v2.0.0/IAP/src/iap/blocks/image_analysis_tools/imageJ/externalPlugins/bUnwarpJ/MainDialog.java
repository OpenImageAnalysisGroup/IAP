...
{ /* begin class MainDialog */
	 ...
	 * @param imageList
	 *           list of images from ImageJ
	 * @param mode
	 *           default registration mode (0 = Fast, 1 = Accurate, 2 = Mono)
	 * @param maxImageSubsamplingFactor
	 *           subsampling factor at highest resolution level
	 * @param min_scale_deformation
	 *           default minimum scale deformation value
	 * @param max_scale_deformation
	 *           default maximum scale deformation value
	 * @param divWeight
	 *           default divergence weight
	 * @param curlWeight
	 *           default curl weight
	 * @param landmarkWeight
	 *           default landmarks weight
	 * @param imageWeight
	 *           default image similarity weight
	 * @param consistencyWeight
	 *           default consistency weight
	 * @param stopThreshold
	 *           default stopping threshold
	 * @param richOutput
	 *           default verbose flag
	 * @param saveTransformation
	 *           default save transformations flag
	 */
	public MainDialog(
	...
	public void itemStateChanged(ItemEvent e)
	{
		...
		// Change in the target image choice
			...
			if (originChoice == this.targetChoice)
			{
				final int newChoiceIndex = originChoice.getSelectedIndex();
				if (targetChoiceIndex != newChoiceIndex)
				{
			...
			// Change in accuracy mode choice
				...
				if (originChoice == this.modeChoice)
				{
				...
				// Change in the minimum scale deformation choice
					...
					if (originChoice == this.minScaleChoice)
					{
					...
					// Change in the maximum scale deformation choice
						...
						if (originChoice == this.maxScaleChoice)
						{
	 ...
	 * @param cx
	 *           b-spline X- coefficients
	 * @param cy
	 *           b-spline Y- coefficients
	 */
	 ...
	 * 
	 * @param bIsReverse
	 *           boolean variable to indicate the use of consistency
	 */
