...
/**
 * Interface for monitoring the progress of a remote stream, such as {@link RemoteInputStream} or {@link RemoteOutputStream}.
 * 
...
public interface RemoteStreamMonitor<StreamServerType> {
	 ...
	 * 
	 * @param stream
	 *           the stream on which the exception was thrown
	 * @param e
	 ...
	 * 
	 * @param stream
	 *           the stream for which the bytes are being transferred
	 * @param numBytes
	 ...
	 * 
	 * @param stream
	 *           the stream for which the bytes are being skipped
	 * @param numBytes
	 *           number of actual bytes skipped
	 * @param isReattempt
	 *           indicates if this is the first attempt
	 *           (<code>false</code>) or a subsequent attempt
	 *           (<code>true</code>)
	 ...
	 * 
	 * @param stream
	 *           the remote stream for which the bytes are being moved
	 * @param numBytes
	 ...
	 *           the stream for which the bytes are being skipped
	 * @param clean
	 *           <code>true</code> iff all data was sent successfully over
	 *           the wire and the stream was closed, <code>false</code> otherwise.
	 */
