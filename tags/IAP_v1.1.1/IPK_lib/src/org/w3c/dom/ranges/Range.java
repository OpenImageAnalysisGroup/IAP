...
public interface Range {
	 ...
	 * @exception RangeException
	 *               INVALID_NODE_TYPE_ERR: Raised if the root container of <code>refNode</code> is not an Attr, Document, or DocumentFragment
	 ...
	 *           node to select.
	 * @exception RangeException
	 *               INVALID_NODE_TYPE_ERR: Raised if an ancestor of <code>refNode</code> is an Entity, Notation or DocumentType node or if <code>refNode</code>
	 ...
	 * boundary-point of Range on which <code>compareBoundaryPoints</code> is invoked.
	 */
	 ...
	 * @param sourceRange
	 *           <code>Range</code> on which this current <code>Range</code> is compared to.
	 ...
	 *               content of the Range are read-only. <br>
	 *               INVALID_STATE_ERR: Raised if <code>detach()</code> has already
	 *               been invoked on this object.
	 */
	 ...
	 *               the Range is of a type that does not allow children of the type of <code>newNode</code> or if <code>newNode</code> is an ancestor of
	 *               the container. <br>
	 *               INVALID_STATE_ERR: Raised if <code>detach()</code> has already
	 *               been invoked on this object.
	 * @exception RangeException
	 ...
	 *               document. <br>
	 *               HIERARCHY_REQUEST_ERR: Raised if the container of the start of
	 *               the Range is of a type that does not allow children of the type of <code>newParent</code> or if <code>newParent</code> is an ancestor
