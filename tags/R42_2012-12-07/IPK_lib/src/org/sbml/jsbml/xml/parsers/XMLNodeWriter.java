/*
 * $Id: XMLNodeWriter.java,v 1.1 2012-11-07 14:43:35 klukas Exp $
 * $URL: https://jsbml.svn.sourceforge.net/svnroot/jsbml/trunk/core/src/org/sbml/jsbml/xml/parsers/XMLNodeWriter.java $
 * ----------------------------------------------------------------------------
...
//		System.err.println("error test txt");
//		System.out.println("StringWriter");
		
		XMLOutputFactory fact = null;
//		try {
//			System.out.println("trying newinstance");
...
//			System.out.println("factory created");
		SMOutputFactory smFactory = new SMOutputFactory(fact);
//		System.out.println("smFactory");
		try {
			XMLStreamWriter writer = smFactory.createStax2Writer(stream);
//			System.out.println("createStax2Writer");
//			writer.writeCharacters("\n");

			XMLNodeWriter xmlNodewriter = new XMLNodeWriter(writer, 0, 2, ' ');
//			System.out.println("XMLNodeWriter");
			xmlNodewriter.write(xmlNode);
//			System.out.println("xmlNodewriter.write(xmlNode);");
			writer.close();
