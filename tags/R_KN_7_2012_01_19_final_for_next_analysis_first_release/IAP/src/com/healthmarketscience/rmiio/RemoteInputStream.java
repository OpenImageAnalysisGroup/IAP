 ...
 * the network. When combined with the {@link RemoteInputStreamServer} subclasses on the server side and the {@link RemoteInputStreamClient} on
...
public interface RemoteInputStream extends Remote {
	 ...
	 * 
	 * @param readSuccess
	 *           <code>true</code> iff all data was read successfully
