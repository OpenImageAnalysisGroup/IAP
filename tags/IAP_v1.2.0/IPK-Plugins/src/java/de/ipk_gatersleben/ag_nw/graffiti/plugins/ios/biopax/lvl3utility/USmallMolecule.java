...
public class USmallMolecule extends UtilitySuperClassToGraph
{
	 ...
	 */
	public static void addAttributesToNode(GraphElement elem, SmallMolecule i) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException
	{
		// first set label to node
		setLabels(elem, i);
		elem.setString(Messages.getString("UtilitySuperClassToGraph.127"), Messages.getString("UtilitySuperClassToGraph.141")); //$NON-NLS-1$ //$NON-NLS-2$
		// set attribute paths
