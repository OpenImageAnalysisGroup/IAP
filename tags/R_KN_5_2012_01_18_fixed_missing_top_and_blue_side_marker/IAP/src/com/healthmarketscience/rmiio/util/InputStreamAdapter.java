...
public abstract class InputStreamAdapter {
	 ...
	 * <p>
	 * Note, this method is slightly optimized for current usage, so an implementation caveat is that the returned packet must be "consumed" before another call
	 * to readPacket is made.
	 * 
	...
	/**
	 * @return a buffer containing the bytes read by the last successful {@link #readTemp} call
	 */
