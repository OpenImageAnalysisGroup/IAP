 ...
 * <p/>
 * To use this class, construct a new <tt>FileDrop</tt> by passing it the target component and a <tt>Listener</tt> to receive notification when file(s) have
 ...
 * </pre></code>
 * <p/>
 * You can specify the border that will appear when files are being dragged by calling the constructor with a <tt>javax.swing.border.Border</tt>. Only
 * <tt>JComponent</tt>s will show any indication with a border.
 * <p/>
 * You can turn on some debugging features by passing a <tt>PrintStream</tt> object (such as <tt>System.out</tt>) into the full constructor. A <tt>null</tt>
...
public class FileDrop {
	 ...
	 * With Debugging turned on, more status messages will be displayed to <tt>out</tt>. A common way to use this constructor is with <tt>System.out</tt> or
	 * <tt>System.err</tt>. A <tt>null</tt> value for
	...
	private static boolean supportsDnD() { // Static Boolean
		if (supportsDnD == null) {
			...
			try {
				InstanceLoader.createInstance("java.awt.dnd.DnDConstants");
				support = true;
			} // end try
			catch (Exception e) {
				support = false;
