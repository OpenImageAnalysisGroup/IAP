...
public class IJ {
	...
	private static boolean isMac, isWin, isJava2, isJava14, isJava15, isJava16, isJava17, isLinux, isVista;
	...
	private static String convert(String command) {
		if (commandTable == null) {
			commandTable = new Hashtable<String, String>(23); // initial capacity should be increased as needed
												...
												if (format.indexOf("png") != -1) {
													...
													if (format.indexOf("pgm") != -1) {
														...
														if (format.indexOf("lut") != -1) {
															...
															if (format.indexOf("measurements") != -1) {
																format = "Measurements...";
															} else
