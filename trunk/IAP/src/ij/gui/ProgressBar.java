...
public class ProgressBar extends Canvas {
	...
	/**
	 * Updates the progress bar, where percent should run from 0 to 1. <code>percent = 1.0</code> erases the bar.
	 ...
	 * @param showInBatchMode
	 *           Whether the progress bar should be shown in
	 *           batch mode.
	 */
