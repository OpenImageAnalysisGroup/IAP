...
public class Macro_Runner implements PlugIn {
	 ...
	 * The file is assumed to be in the macros folder unless <code>name</code> is a full path. ".txt" is
	...
	public String runJavaScript(String script, String arg) {
		...
		try {
			Class<? extends Object> c = js.getClass();
			Method m = c.getMethod("run", new Class[] { script.getClass(), arg.getClass() });
			m.invoke(js, new Object[] { script, arg });
		} catch (Exception e) {
			String msg = "" + e;
