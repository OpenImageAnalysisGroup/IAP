...
public class BatchProcesser implements PlugIn, ActionListener, ItemListener, Runnable {
	...
	public void itemStateChanged(ItemEvent e) {
		...
		if (item.equals("Convert to RGB"))
			...
			if (item.equals("Measure"))
				code = "run(\"Measure\");\n";
			else
				if (item.equals("Resize"))
	...
	String openMacroFromJar(String name) {
		ImageJ ij = IJ.getInstance();
		Class<? extends Object> c = ij != null ? ij.getClass() : (new ImageStack()).getClass();
		String macro = null;
		try {
