...
public abstract class ImageProcessor extends Object {
	...
	public void setThreshold(double minThreshold, double maxThreshold, int lutUpdate) {
		...
		if (lutUpdate == RED_LUT)
			...
			if (lutUpdate == BLACK_AND_WHITE_LUT) {
	 ...
	 * rectangular ROI and a mask. After processing, call <code>reset(mask)</code> to restore non-masked pixels. Here is an example:
	 * 
	 * <pre>
	 ...
	 * for code executed in the <code>run()</code> method of plugins that implement the <code>PlugInFilter</code> interface.
	 * 
	...
	/**
	 * Sets the justification used by drawString(), where <code>justification</code> is CENTER_JUSTIFY, RIGHT_JUSTIFY or LEFT_JUSTIFY. The default is
	 * LEFT_JUSTIFY.
	 */
