...
public class Appearance {
	...
	public static PhongMaterial getMaterial4() {

		Image image = new Image("util/images/earth5.jpg", 1536, 768, false, true);
	...
	public static PointLight getPointLight_letter(Color c, double from, double to ){
