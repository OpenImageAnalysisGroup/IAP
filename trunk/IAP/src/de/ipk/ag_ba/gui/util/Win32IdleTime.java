...
public class Win32IdleTime {
	...
	public interface User32 extends StdCallLibrary {
		 ...
		 * 
		 * @see http://msdn.microsoft.com/library/default.asp?url=/library/en-us/winui/winui/windowsuserinterface/userinput/keyboardinput/keyboardinputreference/
		 *      keyboardinputstructures/lastinputinfo.asp
		 */
	...
	public static int getTickCountWin32() {
		User32.LASTINPUTINFO lastInputInfo = new User32.LASTINPUTINFO();
		User32.INSTANCE.GetLastInputInfo(lastInputInfo);
		return Kernel32.INSTANCE.GetTickCount();
	}
	
	public static int getLastUserInputTimeWin32() {
		User32.LASTINPUTINFO lastInputInfo = new User32.LASTINPUTINFO();
		User32.INSTANCE.GetLastInputInfo(lastInputInfo);
