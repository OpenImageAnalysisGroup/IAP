...
public class PhytochamberTopImageProcessor {
	...
	public PhytochamberTopImageProcessor(int [] rgbImage, int rgbWidth, int rgbHeight, int [] fluorImage, int fluoWidth, int fluoHeight, int [] nearIfImage, int nearWidth, int nearHeight){
		this(ImageConverter.convert1AtoBI(rgbWidth, rgbHeight, rgbImage), ImageConverter.convert1AtoBI(fluoWidth, fluoHeight, fluorImage), ImageConverter.convert1AtoBI(nearWidth, nearHeight, nearIfImage));
	}
...
//		BufferedImage nearMask = modifyMask(newNearImage, getNearNumberOfErodeLoops(), getNearNumberOfDilateLoops(), ImageConfiguration.NirTop);
