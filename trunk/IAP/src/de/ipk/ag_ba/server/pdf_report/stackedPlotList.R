...
stackedPlotList <- list(
		...
		"side.vis.hsv.s.histogram.bin." = list(plotName = "side visible light color saturations (%)", section = 60, subsection = 1, subsubsection = 2, paragraph = 1),  
		...
		"top.vis.hsv.s.histogram.bin." = list(plotName = "top visible light color saturations (%)", section = 60, subsection = 2, subsubsection = 2, paragraph = 1),  
