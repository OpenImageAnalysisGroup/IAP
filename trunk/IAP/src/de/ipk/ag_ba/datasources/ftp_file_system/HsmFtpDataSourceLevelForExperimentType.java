...
public class HsmFtpDataSourceLevelForExperimentType implements DataSourceLevel {
	...
	public HsmFtpDataSourceLevelForExperimentType(String type) {
		this.type = type;
	...
	public Collection<DataSourceLevel> getSubLevels() {
		...
		for (String type : user2experimentList.keySet()) {
			res.add(new HsmFtpDataSourceLevelForUser(type, user2experimentList.get(type)));
		}
		return res;
	}
