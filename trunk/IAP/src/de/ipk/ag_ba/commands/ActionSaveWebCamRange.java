 ...
 * @author klukas
 */
public class ActionSaveWebCamRange extends AbstractNavigationAction {
	...
	public ActionSaveWebCamRange(MongoDB m, ExperimentReference experiment) {
		super("Export WebCam Greenhouse Camera Images");
		this.m = m;
		this.experiment = experiment;
	}
	
	public ActionSaveWebCamRange() {
		super("Export WebCam Greenhouse Camera Images");
	}
