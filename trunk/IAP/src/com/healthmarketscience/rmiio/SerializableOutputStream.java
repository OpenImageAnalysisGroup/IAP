 ...
 * and an OutputStream. In general, this extra layer is not necessary and <em>I do not recommend using this class</em>. However, in the odd case
...
public class SerializableOutputStream extends OutputStream
	 ...
	 *           actual packet sizes may vary. if <code>null</code>, {@link RemoteOutputStreamClient#DEFAULT_CHUNK_SIZE} will be used.
	 */
