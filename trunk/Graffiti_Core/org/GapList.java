...
public class GapList<E> extends AbstractList<E>
	...
	private final E[] EMPTY_ELEMENT_ARRAY = (E[]) new Object[0];
	...
	public GapList<E> clone() {
		try {
			GapList<E> clonedList = (GapList) super.clone();
			int size = size();
			E[] clonedElementData = (E[]) new Object[size];
	 ...
	 * type of the specified array and the size of this list. If the list fits in the specified array with room to spare (i.e., the
	 ...
	 *           index at which to insert first element.
	 * @param elements
	 *           array of elements from which to insert elements.
	 * @param off
	 *           offset in the elements pointing to first element to copy.
	 * @param len
	 *           number of elements to copy from the elements array.
	 */
	 ...
	 *
	 * @param index
	 *           index in the list of the first item being removed.
	 * @param data
	 *           array of objects from which the data are being removed.
	 ...
	 * @param startOff
	 *           offset in the data array of the first element that
	 *           will be removed.
	 * @param endOff
	 *           offset in the data array following the last item that will
	 *           be removed.
	 */
