package org.graffiti.plugins.editcomponents;
 ...
 * Great work! But under what license is this code published? I don’t see any license so I can only assume that copying and using it is not allowed at all.
 * Which contradicts how the code is presented. I’m confused. Could you clarify?
 * Reply
 * Rob Camick said
 * January 1, 2012 at 2:23 pm
 * You are free to use/customize the code as you want.
 * Reply
 */
public class ComponentBorder implements Border {
	 ...
	 *           a valid Edge enum of TOP, LEFT, BOTTOM, RIGHT
	 * @param alignment
	 *           the alignment of the component along the
	 ...
	 * 
	 * @param alignment
	 *           a value in the range 0 - 1.0. Standard values would be
