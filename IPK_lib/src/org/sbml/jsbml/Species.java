/*
 * $Id: Species.java,v 1.1 2012-11-07 14:43:35 klukas Exp $
 * $URL: https://jsbml.svn.sourceforge.net/svnroot/jsbml/trunk/core/src/org/sbml/jsbml/Species.java $
 * ----------------------------------------------------------------------------
...
public class Species extends Symbol {
	 ...
	 * corresponding {@link UnitDefinition} from the {@link Model} to which this {@link Species} belongs will be returned. Otherwise, the size unit from
	 * the surrounding {@link Compartment} of this {@link Species} will be
	 * returned. If this also fails, <code>null</code> will be returned.
	 * 
	 * @return The {@link UnitDefinition} instance which as the {@link #spatialSizeUnitsID} of this {@link Species} as id or the
	 *         size unit of the surrounding {@link Compartment}. <code>Null</code> if it doesn't exist.
	 * @deprecated Only valid for SBML Level 2 Versions 1 and 2.
	 */
	@Deprecated
	...
	/**
	 * @return <code>true</code> if the spatialSizeUnits of this {@link Species} is not <code>null</code>.
	 * @deprecated Only valid for SBML Level 2 Versions 1 and 2.
	 */
	@Deprecated
	 ...
	 *         in case that {@link #hasOnlySubstanceUnits()} is set to <code>true</code> or the spatial dimensions of the surrounding
