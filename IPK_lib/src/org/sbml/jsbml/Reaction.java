/*
 * $Id: Reaction.java,v 1.1 2012-11-07 14:43:32 klukas Exp $
 * $URL: https://jsbml.svn.sourceforge.net/svnroot/jsbml/trunk/core/src/org/sbml/jsbml/Reaction.java $
 * ----------------------------------------------------------------------------
...
public class Reaction extends AbstractNamedSBase implements CallableSBase,
	...
	/**
	 * Creates a Reaction instance. By default, the compartmentID, kineticLaw, {@link #listOfReactants}, {@link #listOfProducts} and {@link #listOfModifiers} are
	 * empty.
	 */
	public Reaction() {
		super();
	 ...
	 * the compartmentID, {@link #kineticLaw}, {@link #listOfReactants}, {@link #listOfProducts} and {@link #listOfModifiers} are empty.
	 * 
	 * @param id
	 * @param level
	 * @param version
	...
	/**
	 * Creates a new {@link KineticLaw} object, installs it as this {@link Reaction}'s 'kineticLaw' sub-element, and returns it.
	...
	/**
	 * Creates a new {@link ModifierSpeciesReference}, adds it to this {@link Reaction}'s list of modifiers and returns it.
	 * 
	...
	/**
	 * Creates a new {@link ModifierSpeciesReference}, which points to the given {@link Species}, adds it to this {@link Reaction}'s {@link #listOfModifiers},
	...
	/**
	 * Creates a new {@link ModifierSpeciesReference} with the given <code>id</code> as its identifier, which points to the given {@link Species}, adds it to
	 * this {@link Reaction}'s {@link #listOfModifiers}, and returns a pointer to it.
	 * 
	 * @param id
	...
	/**
	 * Creates a new {@link ModifierSpeciesReference} with the given <code>id</code> as its identifier, which points to the {@link Species} with the given
	 * <code>id</code>, adds it to this {@link Reaction}'s {@link #listOfModifiers}, and returns a pointer to it.
	 * 
	 * @param id
	 *        the identifier of the {@link ModifierSpeciesReference} to be
	 *        created.
	...
	/**
	 * Creates a new {@link SpeciesReference}, adds it to this {@link Reaction}'s {@link #listOfProducts} and returns it.
	 * 
	...
	/**
	 * Creates a new {@link SpeciesReference}, which points to the given {@link Species}, adds it to this {@link Reaction}'s {@link #listOfProducts} and returns
	 * a pointer to it.
	 * 
	 * @param species
	 *        the {@link Species} to which the {@link SpeciesReference} should point.
	...
	/**
	 * Creates a new {@link SpeciesReference}, adds it to this {@link Reaction}'s {@link #listOfReactants} and returns it.
	 * 
	...
	/**
	 * Creates a new {@link SpeciesReference} with the given <code>id</code> as
	 * identifier, which points to the given {@link Species} and adds it to the {@link #listOfReactants}.
	 * 
	 * @param id
	 *        the identifier of the {@link SpeciesReference} to be created.
	 * @param species
	 ...
	 * 
	 * @return the compartmentID of this {@link Reaction}. The empty {@link String} if it is not set.
	 */
	...
	/**
	 * Searches the first {@link ModifierSpeciesReference} in the {@link #listOfModifiers} of this {@link Reaction} with the given
	 * identifier.
	 * 
	 * @param id
	 *        identifier of the desired {@link ModifierSpeciesReference}.
	 *        Note that this is not the identifier of the {@link Species}.
	 * @return the {@link ModifierSpeciesReference} of the {@link #listOfModifiers} which has 'id' as id (or name depending
	...
	/**
	 * @return the number of {@link ModifierSpeciesReference}s of this {@link Reaction}.
	 */
	...
	/**
	 * Returns the first {@link ModifierSpeciesReference} in the {@link #listOfModifiers} of this {@link Reaction} whose 'species'
	 * attribute points to a {@link Species} with the given identifier.
	 * 
	 * @param id
	 *        The identifier of a referenced {@link Species}
	 * @return the {@link ModifierSpeciesReference} of the {@link #listOfModifiers} which has 'id' as species attribute (or
	...
	/**
	 * Searches the first {@link SpeciesReference} in the listOfProducts of this {@link Reaction} with the given identifier.
	 * 
	 * @param id
	...
	/**
	 * Returns the first {@link SpeciesReference} in the {@link #listOfProducts} of this {@link Reaction} whose 'species' attribute points to a {@link Species}
	...
	public SpeciesReference getReactantBySpeciesId(String speciesId) {
		for (SpeciesReference ref : listOfReactants) {
			if (ref.getSpecies().equals(speciesId)) {
				return ref;
			}
		}
		return null;
	...
	/**
	 * Returns the first {@link SpeciesReference} in the {@link #listOfReactants} of this {@link Reaction} whose 'species'
	 * attribute points to a {@link Species} with the given identifier.
	 * 
	 * @param id
	 *        The identifier of a referenced {@link Species}
	 * @return the {@link SpeciesReference} of the {@link #listOfReactants} which has 'id' as species attribute (or name depending on the
	...
	/**
	 * Sets the compartmentID of this {@link Reaction} to the id of the {@link Compartment} 'compartment'.
	 * 
	 * @param compartment
	 */
	...
	public SpeciesReference getProductBySpeciesId(String speciesId) {
		for (SpeciesReference ref : listOfProducts) {
			if (ref.getSpecies().equals(speciesId)) {
				return ref;
			}
		}
