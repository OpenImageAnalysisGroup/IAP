 ...
 * <p>
 * See the {@link #getInstance} method for details on how the default exporter can be specified as a system property.
 * <p>
 * RemoteStreamExporter implementations are expected to be thread-safe and reentrant after construction.
 * <p>
 * For some helper classes which may be useful for alternative RPC frameworks, see {@link RemoteStreamServerInvokerHelper}, {@link RemoteInputStreamClientProxy}
 * , and {@link RemoteOutputStreamClientProxy}.
 * 
...
public abstract class RemoteStreamExporter {
	...
	/**
	 * name of the default exporter implementation returned by {@link #getInstance} if none is specified via system property
	 */
	 ...
	 *         system property {@link #EXPORTER_PROPERTY} or an instance of {@link #DEFAULT_EXPORTER_CLASS_NAME}. The exporter is
	 ...
	 *            if the stream instance could not be exported
	 */
	public <StreamType,
	 ...
	 * same instance.
	 * <p>
	 * Note, RemoteStreamServer implements Unreferenced, which is an rmi interface used to clean up servers which have lost their clients. RPC frameworks which
	 * export remote streams should attempt to handle abnormal client termination, and are encouraged to make use of the Unreferenced interface to shutdown an
