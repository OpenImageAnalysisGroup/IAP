...
/**
 * Calculates the plant width and height (in the left and right part of the image separately) properties from the visible light image mask.
 * 
 * @author klukas
 */
public class BlCalcWidthAndHeightLR extends
	...
	protected Image processVISmask() {
		...
		Image inImg = useFluo ? input().masks().fluo()
				: input().masks().vis();
		int run = 0;
