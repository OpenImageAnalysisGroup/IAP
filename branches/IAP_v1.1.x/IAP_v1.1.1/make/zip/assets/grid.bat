...
cd
:download
echo Current client will be downloaded from http://iap.ipk-gatersleben.de/iap.jar
java -cp iap.jar iap.Download http://iap.ipk-gatersleben.de/iap.jar iap2.jar
