 ...
 * the network. When combined with the {@link RemoteOutputStreamServer} subclasses on the server side and the {@link RemoteOutputStreamClient} on
 ...
 * <p>
 * An actual instance of this class is not intended for use by more than one client, and should be treated in a similar manner to an "un-synchronized" local
 * interface.
 * 
...
public interface RemoteOutputStream extends Remote, Flushable {
	 ...
	 * the wire.
	 * 
	 * @return <code>true</code> iff the stream data is compressed, <code>false</code> otherwise
	 */
	 ...
	 * 
	 * @param writeSuccess
	 *           <code>true</code> iff all data was sent successfully
