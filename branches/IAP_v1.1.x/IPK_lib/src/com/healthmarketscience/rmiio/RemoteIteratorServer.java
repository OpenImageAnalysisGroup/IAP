...
public class RemoteIteratorServer<DataType> implements Closeable {
	 ...
	 * 
	 * @param exporter
	 *           the exporter which will handle exporting the underlying
	 ...
	 * way or another on the server object (may be left to the underlying stream <code>unreferenced</code> method if the server object must live beyond
