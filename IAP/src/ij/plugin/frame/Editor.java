...
public class Editor extends PlugInFrame implements ActionListener, ItemListener,
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ("Save".equals(what))
			...
			if ("Compile and Run".equals(what))
				compileAndRun();
			else
				if ("Run Macro".equals(what)) {
					if (altKeyDown) {
						enableDebugging();
						runMacro(true);
					} else
					...
					if ("Debug Macro".equals(what)) {
						...
						if ("Step".equals(what))
							...
							if ("Trace".equals(what))
								setDebugMode(Interpreter.TRACE);
							else
								if ("Fast Trace".equals(what))
									setDebugMode(Interpreter.FAST_TRACE);
								else
									if ("Run".equals(what))
										setDebugMode(Interpreter.RUN);
									else
										if ("Run to Insertion Point".equals(what))
											runToInsertionPoint();
										else
											if ("Abort".equals(what) || "Abort Macro".equals(what)) {
												Interpreter.abort();
												IJ.beep();
											} else
												if ("Evaluate Line".equals(what))
													evaluateLine();
												else
													if ("Install Macros".equals(what))
														installMacros(ta.getText(), true);
													else
														if ("Function Finder...".equals(what))
															new FunctionFinder();
														else
															if ("Evaluate JavaScript".equals(what))
																evaluateJavaScript();
															else
																if ("Print...".equals(what))
																	print();
																else
																		...
																		if (what.equals("Copy"))
																			...
																			if (what.equals("Cut"))
																				...
																				if ("Save As...".equals(what))
																					...
																					if ("Select All".equals(what))
																						selectAll();
																					else
																						if ("Find...".equals(what))
																							find(null);
																						else
																							if ("Find Next".equals(what))
																								find(searchString);
																							else
																								if ("Go to Line...".equals(what))
																									gotoLine();
																								else
																									if ("Zap Gremlins".equals(what))
																										zapGremlins();
																									else
																										if ("Make Text Larger".equals(what))
																											changeFontSize(true);
																										else
																											if ("Make Text Smaller".equals(what))
																												changeFontSize(false);
																											else
																												if ("Save Settings".equals(what))
																													saveSettings();
																												else
																													if ("New...".equals(what))
																														IJ.run("Text Window");
																														...
																														if ("Open...".equals(what))
																															...
																															if (what.equals("Copy to Image Info"))
																																copyToInfo();
																															else {
																																if (altKeyDown) {
																																	enableDebugging();
