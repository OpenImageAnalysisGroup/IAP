...
public class Colors implements PlugIn, ItemListener {
	...
	public static Color getColor(String name, Color defaultColor) {
		...
		if (name.equals(colors[0]))
			...
			if (name.equals(colors[1]))
				c = Color.green;
			else
				if (name.equals(colors[2]))
					c = Color.blue;
				else
					if (name.equals(colors[3]))
						c = Color.magenta;
					else
						if (name.equals(colors[4]))
							c = Color.cyan;
						else
							if (name.equals(colors[5]))
								c = Color.yellow;
							else
								if (name.equals(colors[6]))
									c = Color.orange;
								else
									if (name.equals(colors[7]))
										c = Color.black;
									else
										if (name.equals(colors[8]))
											c = Color.white;
		return c;
	}
					...
					if (hex.equals("000000"))
						...
						if (hex.equals("ffffff"))
							...
							if (hex.equals("ffff00"))
								...
								if (hex.equals("00ffff"))
									color = "cyan";
								else
									if (hex.equals("ff00ff"))
										color = "magenta";
		return color;
	}
