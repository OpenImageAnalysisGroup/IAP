...
public class Convolver implements ExtendedPlugInFilter, DialogListener, ActionListener {
	...
	/**
	 * Convolves the float image <code>ip</code> with a kernel of width <code>kw</code> and height <code>kh</code>. Returns false if
	...
	/**
	 * Convolves the image <code>ip</code> with a kernel of width <code>kw</code> and height <code>kh</code>.
	 */
