...
public class GaussianBlur implements ExtendedPlugInFilter, DialogListener {
	 ...
	 * 
	 * @param ip
	 *           The ImageProcessor to be filtered.
	 * @param sigmaX
	 *           Standard deviation of the Gaussian in x direction (pixels)
	 * @param sigmaY
	 *           Standard deviation of the Gaussian in y direction (pixels)
	 * @param accuracy
	 ...
	 * 
	 * @param ip
	 *           The FloatProcessor to be filtered.
	 * @param sigmaX
	 *           Standard deviation of the Gaussian in x direction (pixels)
	 * @param sigmaY
	 *           Standard deviation of the Gaussian in y direction (pixels)
	 ...
	 * 
	 * @param ip
	 *           The Image with the original data where also the result will be stored
	 * @param sigma
	 *           Standard deviation of the Gaussian
	 * @param accuracy
	 *           Accuracy of kernel, should not be > 0.02
	 * @param xDirection
	 ...
	 * @param readTo
	 *           Last array element+1 of the line that must be read. <code>writeTo+kernel.length</code> or <code>input.length</code>
	 * @param writeFrom
	 ...
	 * @param radius
	 *           The range above and below the roi that should be processed
	 */
