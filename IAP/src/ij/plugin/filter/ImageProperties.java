...
public class ImageProperties implements PlugInFilter, TextListener {
		...
		if (unit.equals("cm") || unit.startsWith("cent"))
			...
			if (unit.equals("mm") || unit.startsWith("milli"))
				...
				if (unit.startsWith("inch"))
					...
					if (unit.startsWith("" + IJ.micronSymbol) || unit.startsWith("u") || unit.startsWith("micro"))
						return MICROMETER;
					else
	...
	public void textValueChanged(TextEvent e) {
		...
		Tools.parseDouble(((TextField) nfields.elementAt(2)).getText(), -99);
		Tools.parseDouble(((TextField) nfields.elementAt(3)).getText(), -99);
		Tools.parseDouble(((TextField) nfields.elementAt(4)).getText(), -99);
