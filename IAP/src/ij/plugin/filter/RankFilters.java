...
public class RankFilters implements ExtendedPlugInFilter, DialogListener {
	 ...
	 * 
	 * @param arg
	 *           Defines type of filter operation
	 * @param imp
	 *           The ImagePlus to be processed
		...
		if (arg.equals("mean"))
			...
			if (arg.equals("min"))
				...
				if (arg.equals("max"))
					...
					if (arg.equals("variance"))
						filterType = VARIANCE;
					else
						if (arg.equals("median"))
							filterType = MEDIAN;
						else
							if (arg.equals("outliers"))
								filterType = OUTLIERS;
							else
								if (arg.equals("despeckle"))
