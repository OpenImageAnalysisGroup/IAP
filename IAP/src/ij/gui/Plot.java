...
public class Plot {
	 ...
	 *           the y-axis label
	 * @param xValues
	 *           the x-coodinates, or null
	 * @param yValues
	 *           the y-coodinates, or null
	 * @param flags
	 *           sum of flag values controlling appearance of ticks, grid, etc.
	 */
	public Plot(String title, String xLabel, String yLabel, float[] xValues, float[] yValues, int flags) {
		...
		this.yLabel = yLabel;
		this.flags = flags;
		storedData = new ArrayList<float[]>();
	 ...
	 *           the y-coodinates
	 * @param shape
	 *           CIRCLE, X, BOX, TRIANGLE, CROSS, DOT or LINE
	 */
	...
	/**
	 * Sets the justification used by addLabel(), where <code>justification</code> is ImageProcessor.LEFT, ImageProcessor.CENTER or ImageProcessor.RIGHT.
	 */
