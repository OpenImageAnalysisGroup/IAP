 ...
 * desired).
 * <p>
 * <i>Warning, beware layering a PrintWriter or PrintStream on top of a RemoteOutputStream</i>, as both of the aforementioned classes "swallow" IOExceptions
 * (well, they don't swallow them, you just have to test for them). In such a scenario, a client will not detect a problem in the remote stream unless they
...
public class RemoteOutputStreamClient {
	...
	/**
	 * Wraps a RemoteOutputStream as an OutputStream using the {@link RemoteRetry#SIMPLE} retry policy.
	 * 
	 * @param remoteOut
	 *           a remote output stream interface
	 ...
	 *           a remote output stream interface
	 * @param retry
	 *           RemoteException retry policy to use, if <code>null</code>, {@link #DEFAULT_RETRY} will be used.
	 * @return an OutputStream which will write to the given RemoteOutputStream
	 */
	public static OutputStream wrap(RemoteOutputStream remoteOut,
												RemoteRetry retry)
	 ...
	 *           actual packet sizes may vary. if <code>null</code>, {@link #DEFAULT_CHUNK_SIZE} will be used.
	 * @return an OutputStream which will write to the given RemoteOutputStream
	 */
	public static OutputStream wrap(RemoteOutputStream remoteOut,
												RemoteRetry retry,
