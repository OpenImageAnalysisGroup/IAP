...
//		test.doZoom(2.0, Scaling.BILINEAR);
	...
	private int bilinear(int newPosition_i, int newPosition_j, double factor) {	// für Grauwert
		...
		newGrayValue = src_image[positionInTheOriginalImage_i][positionInTheOriginalImage_j] * (1-distanceFromExactToOriginalPosition_i) * (1-distanceFromExactToOriginalPosition_j);
		
		if(positionInTheOriginalImage_i > 0)
			newGrayValue += src_image[positionInTheOriginalImage_i-1][positionInTheOriginalImage_j]* distanceFromExactToOriginalPosition_i * (1-distanceFromExactToOriginalPosition_j);
					
		if(positionInTheOriginalImage_j > 0)
			newGrayValue += src_image[positionInTheOriginalImage_i][positionInTheOriginalImage_j-1] * (1-distanceFromExactToOriginalPosition_i) * distanceFromExactToOriginalPosition_j;
				
		if(positionInTheOriginalImage_i > 0 && positionInTheOriginalImage_j > 0)
			newGrayValue += src_image[positionInTheOriginalImage_i-1][positionInTheOriginalImage_j-1] * distanceFromExactToOriginalPosition_i * distanceFromExactToOriginalPosition_j;
