...
public class ActionDataExportToDefinedFileSystemFolder extends AbstractNavigationAction implements NavigationAction {
	...
	public void performActionCalculateResults(NavigationButton src) throws Exception {
		...
		String storage_path = getHsmPath(File.separator);
	...
	public static String getHsmPath(String s) {
		return SystemOptions.getInstance().getString("ARCHIVE", "HSM path",
				s + s + "hsm" + s + "LIMS" + s + "HET" + s + "PHENOTYPING" + s + "Analysis_Archive_C" + s);
	}
