...
\subsection{IAP based formula - Visible Light (max of side area)}
\begin{itemize}
...
\subsection{Relative growth of volume (IAP based formular - visible light)}
\begin{itemize}
\item Digital biomass growth in percent (per day) based on the side.area and top.area
...
\subsection{Yellow intensity}
\begin{itemize}
\item Average activity of the yellow reflection
reflection.
\item The darker the higher acitivity
\item Column name: xxx
\item Unit: %
\end{itemize}
\loadTex{side_fluo_histogram_phenol_bin_1_0_25_side_fluo_histogram_phenol_bin_2stackedOverallImage}
\loadTex{top_fluo_histogram_phenol_bin_1_0_25_top_fluo_histogram_phenol_bin_2_2stackedOverallImage}

\subsection{Yellow normalized intensity}
\begin{itemize}
\item Average activity of the normalized yellow reflection
reflection.
\item The darker the higher acitivity
\item Column name: xxx
\item Unit: %
\end{itemize}
\loadTex{side_fluo_normalized_histogram_phenol_bin_1_0_25_side_fluo_normalized_stackedOverallImage}
...
\subsection{Near-infrared ratio intensity}
\begin{itemize}
\item xxx
\item Represents the water content of the plant
\item Column name: xxx
\item Unit: %
\end{itemize}
\loadTex{side_nir_histogram_ratio_bin_1_0_25_side_nir_histogram_ratio_nir_2_25_stackedOverallImage}
\loadTex{top_nir_histogram_ratio_bin_1_0_25_top_nir_histogram_ratio_bin_2_25_51stackedOverallImage}

\subsection{Near-infrared intensity (yellow)}
\begin{itemize}
\item xxx
\item Represents the water content of the plant
\item Column name: xxx
\item Unit: %
\end{itemize}
\loadTex{side_nir_histogram_phenol_bin_1_0_25_side_nir_histogram_phenol_bin_2_2stackedOverallImage}
\loadTex{top_nir_histogram_phenol_bin_1_0_25_top_nir_histogram_phenol_bin_2_25_stackedOverallImage}
