...
\ifthenelse{\boolean{isFile1}}{
	\subsection{Experiment factor groups}
...
\checkFileNoReset{side_area_norm__mm2_violinplot.pdf}{}{}
\checkFileNoReset{top_area_norm__mm2_violinplot.pdf}{}{}
\checkFileNoReset{side_fluo_intensity_average__relative_violinplot.pdf}{}{}
\checkFileNoReset{side_nir_intensity_average__relative_violinplot.pdf}{}{}
\checkFileNoReset{side_width_norm__mm_violinplot.pdf}{}{}
\checkFileNoReset{side_height_norm__mm_violinplot.pdf}{}{}
\checkFileNoReset{side_vis_hue_averageviolinplot.pdf}{}{}
\checkFileNoReset{top_vis_hue_averageviolinplot.pdf}{}{}
\ifthenelse{\boolean{isFile1}}{
	...
	\ifthenelse{\boolean{isFile1}}{
		...
		\checkFile{side_area_norm__mm2_violinplot.pdf}{top_area_norm__mm2_violinplot.pdf}{side_fluo_intensity_average__relative_violinplot.pdf}
		\ifthenelse{\boolean{isFile1}}{
			\loadImage{side_area_norm__mm2_violinplot.pdf}
		}{}
		
		\ifthenelse{\boolean{isFile2}}{
			\loadImage{top_area_norm__mm2_violinplot.pdf}
		}{}
		
		\ifthenelse{\boolean{isFile3}}{
			\loadImage{side_fluo_intensity_average__relative_violinplot.pdf}
		}{}
	
		\checkFile{side_nir_intensity_average__relative_violinplot.pdf}{side_width_norm__mm_violinplot.pdf}{side_height_norm__mm_violinplot.pdf}
		\ifthenelse{\boolean{isFile1}}{
			\loadImage{side_nir_intensity_average__relative_violinplot.pdf}
		}{}
		
		\ifthenelse{\boolean{isFile2}}{
			\loadImage{side_width_norm__mm_violinplot.pdf}
		}{}
		
		\ifthenelse{\boolean{isFile3}}{
			\loadImage{side_height_norm__mm_violinplot.pdf}
		}{}
	
		\checkFile{side_vis_hue_averageviolinplot.pdf}{top_vis_hue_averageviolinplot.pdf}{}
		\ifthenelse{\boolean{isFile1}}{
			\loadImage{side_vis_hue_averageviolinplot.pdf}
		}{}
		
		\ifthenelse{\boolean{isFile2}}{
			\loadImage{top_vis_hue_averageviolinplot.pdf}
		}{}
	}{}			
}{}
...
\checkFileNoReset{top_ir_intensity_averagenboxplot.pdf}{}{}
\checkFileNoReset{side_ir_intensity_averagenboxplot.pdf}{}{}
...
\ifthenelse{\boolean{isFile1}}{
	...
	\item Represents the heat of the plant
	\end{itemize}
	
	\checkFile{side_ir_intensity_averagenboxplot.pdf}{top_ir_intensity_averagenboxplot.pdf}{}
	\ifthenelse{\boolean{isFile1} \or \boolean{isFile2}}{
		\ownClearPage
		...
		\ifthenelse{\boolean{isFile1}}{	
			...
			\loadImage{side_ir_intensity_averagenboxplot.pdf}
		}{}
		\ifthenelse{\boolean{isFile2}}{
			Average IR intensity for top view:
			\loadImage{top_ir_intensity_averagenboxplot.pdf}
		}{}
	}{}
