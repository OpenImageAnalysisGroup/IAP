...
public class IAPgui {
	...
	public static JComponent getMainGUIcontent(
		...
		return getMainGUIcontent(myStatus, secondWindow, optCustomHomeAction, null, true, (JFrame) null);
	}
	...
	public static JComponent getMainGUIcontent(
		...
		if (jff != null)
			guiSetting.setCloseRunnable(new Runnable() {
				@Override
				public void run() {
					jff.dispatchEvent(new WindowEvent(jff, WindowEvent.WINDOW_CLOSING));
				}
			});
