 ...
 * @author klukas
 */
public class ActionPhenotypeAnalysis extends AbstractNavigationAction implements RemoteCapableAnalysisAction {
	...
	public ActionPhenotypeAnalysis(MongoDB m, double epsilon, double epsilon2,
	...
	public ActionPhenotypeAnalysis() {
		super("Create phenotype data set");
	}
