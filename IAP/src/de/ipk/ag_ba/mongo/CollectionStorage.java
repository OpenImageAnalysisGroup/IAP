...
public class CollectionStorage {
	...
	public CollectionStorage(DB db, boolean ensureIndex) {
		...
		if (ensureIndex)
			fs_image_files.ensureIndex(MongoGridFS.FIELD_FILENAME.toString());
		...
		if (ensureIndex)
			fs_image_labels.ensureIndex(MongoGridFS.FIELD_FILENAME.toString());
		...
		if (ensureIndex)
			fs_preview_files.ensureIndex(MongoGridFS.FIELD_FILENAME.toString());
