...
public class BlockRemoveSmallStructuresFromVisAndFluoUsingOpening extends AbstractSnapshotAnalysisBlockFIS {
	
	@Override
	protected FlexibleImage processVISmask() {
		FlexibleImage mask = new ImageOperation(getInput().getMasks().getVis()).opening(1).getImage();
