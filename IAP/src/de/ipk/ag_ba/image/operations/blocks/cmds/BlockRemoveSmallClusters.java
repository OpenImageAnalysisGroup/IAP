...
public class BlockRemoveSmallClusters extends AbstractSnapshotAnalysisBlockFIS {
	...
	protected FlexibleImage processVISmask() {
		...
		return new ImageOperation(getInput().getMasks().getVis()).removeSmallClusters(options.getDoubleSetting(Setting.REMOVE_SMALL_CLUSTER_SIZE_RGB),
				options.getNeighbourhood(), options.getCameraTyp()).getImage();
	}
