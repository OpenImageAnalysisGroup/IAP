...
import de.ipk.ag_ba.image.operations.blocks.cmds.arabidopsis.BlClearMasks_Arabidopsis_ClearOutSideSinglePot_vis;
...
public class ArabidopsisAnalysisPipelineBlueSmallAndMiddle extends AbstractImageProcessor {
	...
	protected BlockPipeline getPipeline(ImageProcessorOptions options) {
		...
		p.add(BlClearMasks_Arabidopsis_ClearOutSideSinglePot_vis.class);
