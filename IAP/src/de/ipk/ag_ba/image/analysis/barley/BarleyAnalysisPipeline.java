...
import de.ipk.ag_ba.image.operations.blocks.cmds.BlockColorBalancingRoundCamera_nir;
import de.ipk.ag_ba.image.operations.blocks.cmds.BlockColorBalancing_fluo;
...
import de.ipk.ag_ba.image.operations.blocks.cmds.BlockMedianFilter_vis;
...
public class BarleyAnalysisPipeline extends AbstractImageProcessor {
	...
	protected BlockPipeline getPipeline(ImageProcessorOptions options) {
		...
		p.add(BlockColorBalancing_fluo.class);
		p.add(BlockCreateDummyReferenceIfNeeded_vis.class);
		p.add(BlockColorBalancingRoundCamera_nir.class);
		...
		p.add(BlockMedianFilter_vis.class);
		p.add(BlockMedianFilter_vis.class);
		p.add(BlockMedianFilter_vis.class);
