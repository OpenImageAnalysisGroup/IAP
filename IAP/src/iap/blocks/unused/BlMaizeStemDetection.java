...
public class BlMaizeStemDetection extends AbstractSnapshotAnalysisBlock implements CalculatesProperties {
	...
	protected Image processVISmask() {
		...
		ImageOperation inDilatedForSectionDetection = img.copy().bm().dilate(10).io().show("Dilated image for section detection", debug);
		...
		getResultSet().storeResults(cp(), CameraType.VIS, TraitCategory.GEOMETRY, rt, getBlockPosition(), this, input().images().getVisInfo());
